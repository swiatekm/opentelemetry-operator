...
WARNING: The per-node strategy currently ignores targets without a Node, like control plane components.<br/>
        ...
        <td><b><a href="#targetallocatorspecallocationstrategyconfig">allocationStrategyConfig</a></b></td>
        <td>object</td>
        <td>
...
### TargetAllocator.spec.allocationStrategyConfig
<sup><sup>[↩ Parent](#targetallocatorspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#targetallocatorspecallocationstrategyconfigpernode">perNode</a></b></td>
        <td>object</td>
        <td>
...
### TargetAllocator.spec.allocationStrategyConfig.perNode
<sup><sup>[↩ Parent](#targetallocatorspecallocationstrategyconfig)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#targetallocatorspecallocationstrategyconfigpernodefallbackstrategy">fallbackStrategy</a></b></td>
        <td>object</td>
        <td>
...
### TargetAllocator.spec.allocationStrategyConfig.perNode.fallbackStrategy
<sup><sup>[↩ Parent](#targetallocatorspecallocationstrategyconfigpernode)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>enum</td>
        <td>
          Name is the name of the allocation strategy to use as the fallback.<br/>
          <br/>
            <i>Enum</i>: least-weighted, consistent-hashing, per-node<br/>
        </td>
        <td>true</td>
