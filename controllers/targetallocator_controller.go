...
func (r *TargetAllocatorReconciler) getCollector(ctx context.Context, instance v1alpha1.TargetAllocator) (*v1beta1.OpenTelemetryCollector, error) {
	...
	if len(collectors.Items) == 0 {
		...
		return nil, fmt.Errorf("found multiple OpenTelemetry collectors annotated with the same Target Allocator: %v", instance.GetName())
	}
...
func (r *TargetAllocatorReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	ctrlBuilder.Watches(
		...
		handler.EnqueueRequestsFromMapFunc(r.getEmbeddedTargetAllocatorRequests),
	...
	ctrlBuilder.Watches(
		&v1beta1.OpenTelemetryCollector{},
		handler.EnqueueRequestsFromMapFunc(r.getTargetAllocatorRequestsFromLabel),
...
func (r *TargetAllocatorReconciler) getEmbeddedTargetAllocatorRequests(_ context.Context, collector client.Object) []reconcile.Request {
...
func (r *TargetAllocatorReconciler) getTargetAllocatorRequestsFromLabel(_ context.Context, collector client.Object) []reconcile.Request {
